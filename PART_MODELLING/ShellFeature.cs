public static int Startup()
{
	try
	{
		...
		if (workPart != null)
		{
			...
			Shell shell = null;
			ShellBuilder builder = workPart.Features.CreateShellBuilder(shell);
			builder.DefaultThickness.Value = 0.5;
			builder.Tolerance = 0.01;
			builder.Body = partBody;
			...
			collector.ReplaceRules(new SelectionIntentRule[] { stationary }, false);
